package com.programingtechie.productservice;
...
class ProductServiceApplicationTests {
	...
	@Autowired
	private ObjectMapper objectMapper;// converts object to json and vice versa
	...
	private ProductRequest getProductRequest() {
		return ProductRequest.builder().name("Iphone 13").description("Iphone 13").price(BigDecimal.valueOf(1300))
				.build();
